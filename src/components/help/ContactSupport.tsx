  ...
  return (
    <div id="contact-support" className="max-w-5xl mx-auto px-4 sm:px-6 mb-10">
      <div className="bg-white dark:bg-[#0b1220] border border-[#e8ebe8] dark:border-white/10 rounded-2xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#1a3d2b] to-[#1a5c3a] px-5 sm:px-8 py-5 sm:py-6 text-white">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 mt-4">
            {[
              ...
              <span
                key={chip.label}
                className="bg-white/10 text-white text-2xs sm:text-xs rounded-full px-2.5 sm:px-3 py-1 sm:py-1.5 flex items-center gap-1.5"
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#e8ebe8] dark:divide-white/10">
          ...
          {/* Email / Ticket */}
          <div className="flex flex-col items-center text-center px-5 sm:px-8 py-6 sm:py-8">
          ...
          <div className="flex flex-col items-center text-center px-5 sm:px-8 py-6 sm:py-8">
            ...
            <a href="tel:+919238417169" className="btn-outline w-full mt-4 truncate">Call +91 92384 17169</a>
