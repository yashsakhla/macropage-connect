...
export default function RuleCard({ rule, readOnly, onEdit, onToggle, onDelete, onDuplicate }: Props) {
  ...
  return (
    <div className="flex items-center gap-4 px-5 py-4 hover:bg-[#fafbfa] dark:hover:bg-white/[0.03] transition-colors">
      <div className={cn('w-11 h-11 rounded-xl flex items-center justify-center flex-shrink-0', TrigIcon.bg)}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <span className="badge badge-green mt-1.5 text-2xs">{triggerSummary(rule)}</span>
