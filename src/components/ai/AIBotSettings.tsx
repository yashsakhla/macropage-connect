          ...
          <div className="space-y-3">
            {[
              ...
              <label key={key} className="flex items-center justify-between cursor-pointer">
                ...
                >
                  <span className={cn('inline-block h-3.5 w-3.5 rounded-full bg-white shadow transition-transform mt-0.5', config.triggers[key as keyof typeof config.triggers] ? 'translate-x-[18px]' : 'translate-x-0.5')} />
                </button>
              </label>
            ))}
          </div>
