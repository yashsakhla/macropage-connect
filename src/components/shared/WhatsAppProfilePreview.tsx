  ...
  return (
    <div className="flex flex-col items-center">
      <div className="flex items-center gap-2 mb-4">
        ...
        <div className="text-xs font-medium text-gray-500 dark:text-gray-400">Live preview</div>
        <div className="ml-2 bg-[#e8f5ee] dark:bg-emerald-950/30 text-[#1a5c3a] text-2xs rounded-full px-2 py-0.5">Updates as you type</div>
      </div>
      ...
      {/* Info card and pills */}
      <div className="max-w-[260px] mt-4 bg-[#e8f5ee] dark:bg-emerald-950/30 border border-[#c8e6d4] rounded-xl p-3 text-center">
        <div className="text-2xs text-[#1a5c3a] leading-relaxed">👁 This is how customers see your profile on WhatsApp</div>
        <div className="mt-3 flex flex-wrap gap-2 justify-center">
          {pills.map(p => (
            <div key={p.key} className={cn('flex items-center gap-1 text-2xs rounded-full px-2 py-0.5', p.done ? 'bg-[#e8f5ee] dark:bg-emerald-950/30 text-[#1a5c3a]' : 'bg-gray-100 dark:bg-white/10 text-gray-400 dark:text-gray-500')}>
