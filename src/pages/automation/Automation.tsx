    ...
    <div className="min-h-screen bg-[#f7f8f6] p-6">
      ...
      <div className="flex items-start justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Set up auto-replies, flows and AI to handle conversations automatically</p>
        </div>
      ...
      {/* ── Section tabs ── */}
      <div className="bg-white border border-[#e8ebe8] rounded-2xl mb-5 overflow-hidden">
        <div className="flex">
          {TAB_META.map((tab, i) => {
            const Icon = tab.icon
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isActive
                    ? cn('bg-white', tab.activeBorder)
                    : 'border-b-transparent bg-[#fafafa] hover:bg-white'
                )}
              >
                {/* icon bubble */}
                <div className={cn(
                  ...
                  <Icon size={16} className={isActive ? tab.iconColor : 'text-gray-400'} />
                </div>
                ...
                {count !== null && count > 0 && (
                  <span className={cn(
                    ...
                    isActive ? cn(tab.iconBg, tab.activeColor) : 'bg-gray-100 text-gray-400'
                  )}>
                    {count}
                  </span>
                )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 bg-black/40">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
            <div className="flex items-center justify-between mb-5">
              <h3 className="text-base font-bold text-gray-900">What would you like to create?</h3>
              ...
              {CREATION_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    onClick={opt.action}
                    className={cn(
                      'w-full bg-white border-2 border-[#e8ebe8] rounded-2xl p-4',
